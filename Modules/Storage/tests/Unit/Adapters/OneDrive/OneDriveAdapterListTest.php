...
final class OneDriveAdapterListTest extends TestCase
{
    ...
    public function test_browse_lists_folders_and_image_files(): void
    {
        ...
        $result = app(StorageAdapterFactory::class)->make($account)->list(new StorageListOptions(
            perPage: 25,
            containerId: null,
            includeAlbums: true,
            includeItems: true,
    ...
    public function test_browse_throws_when_graph_returns_error(): void
    {
        ...
        app(StorageAdapterFactory::class)->make($account)->list(new StorageListOptions(
            perPage: 25,
            containerId: null,
            includeAlbums: true,
            includeItems: true,
