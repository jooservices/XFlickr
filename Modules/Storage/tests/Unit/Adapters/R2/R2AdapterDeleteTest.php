...
final class R2AdapterDeleteTest extends TestCase
{
    public function test_delete_many_removes_existing_objects(): void
    {
        ...
        $result = app(StorageAdapterFactory::class)->make($account)->delete([$itemId]);
    ...
    public function test_delete_many_collects_failures_without_aborting_batch(): void
    {
        ...
        $result = app(StorageAdapterFactory::class)->make($account)->delete([$failingId, $successId]);
