...
final class ThumbnailServiceTest extends TestCase
{
    public function test_stream_returns_image_response_for_valid_media_item(): void
    {
        ...
        $response = app(ThumbnailService::class)->stream($account->id, $mediaItemId);
    ...
    public function test_stream_rejects_unknown_account(): void
    {
        ...
        app(ThumbnailService::class)->stream(999999, fake()->uuid());
    }
    ...
    public function test_stream_rejects_unauthorized_thumbnail_domain(): void
    {
        ...
        app(ThumbnailService::class)->stream($account->id, $mediaItemId);
    }
    ...
    public function test_stream_rejects_non_google_photos_account(): void
    {
        ...
        app(ThumbnailService::class)->stream($account->id, fake()->uuid());
    }
