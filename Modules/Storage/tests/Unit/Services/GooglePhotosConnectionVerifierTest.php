...
final class GooglePhotosConnectionVerifierTest extends TestCase
{
    ...
    public function test_verify_rejects_non_google_photos_account(): void
    {
        ...
        app(GooglePhotosConnectionVerifier::class)->verify($account);
    }
    ...
    public function test_verify_reports_missing_scopes_without_calling_api(): void
    {
        ...
        $report = app(GooglePhotosConnectionVerifier::class)->verify($account);
    ...
    public function test_verify_marks_truncated_when_pagination_exceeds_max_pages(): void
    {
        ...
        $report = app(GooglePhotosConnectionVerifier::class)->verify($account, sampleLimit: 5, maxPages: 1);
