...
final class StorageGoogleTokenServiceTest extends TestCase
{
    ...
    public function test_client_rejects_incomplete_credentials(): void
    {
        ...
        app(StorageGoogleTokenService::class)->client([
            'client_id' => 'client-id',
        ]);
    }
    ...
    public function test_access_token_returns_valid_cached_token_without_refresh(): void
    {
        ...
        $accessToken = app(StorageGoogleTokenService::class)->accessToken($account->credentials ?? [], $account);
    ...
    public function test_access_token_refreshes_expired_credentials_and_persists(): void
    {
        ...
        $service = Mockery::mock(StorageGoogleTokenService::class)->makePartial();
