...
final class R2BrowseServiceTest extends TestCase
{
    public function test_browse_lists_folders_and_image_files(): void
    {
        ...
        $result = app(R2BrowseService::class)->browse($credentials);
    ...
    public function test_browse_uses_container_prefix_and_pagination_tokens(): void
    {
        ...
        $result = app(R2BrowseService::class)->browse(
            $credentials,
    ...
    public function test_browse_can_return_only_albums(): void
    {
        ...
        $result = app(R2BrowseService::class)->browse($credentials, includeItems: false);
