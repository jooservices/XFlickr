...
final class R2DeleteServiceTest extends TestCase
{
    ...
    public function test_delete_many_removes_existing_objects(): void
    {
        ...
        $result = app(R2DeleteService::class)->deleteMany($account, [$itemId]);
    ...
    public function test_delete_many_collects_failures_without_aborting_batch(): void
    {
        ...
        $result = app(R2DeleteService::class)->deleteMany($account, [$failingId, $successId]);
