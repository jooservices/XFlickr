...
use Modules\Storage\Services\GoogleDriveBrowseService;
use Modules\Storage\Services\StorageGoogleTokenService;
use Tests\Concerns\SafeRefreshDatabase;
use Tests\TestCase;

final class GoogleDriveBrowseServiceTest extends TestCase
{
    ...
    public function test_browse_lists_folders_and_image_files(): void
    {
        ...
        $result = app(GoogleDriveBrowseService::class)->browse(
            $account->credentials ?? [],
            $account,
        );
