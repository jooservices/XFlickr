...
namespace Modules\Storage\Tests\Unit\Dto;

use Modules\Storage\Dto\ResolvedSource;
use Tests\TestCase;

final class ResolvedSourceTest extends TestCase
{
    public function test_can_be_constructed_with_all_properties(): void
    {
        ...
        $dto = new ResolvedSource($url, $destinationPath, $originalName, $variant, $metadata);
    ...
    public function test_metadata_defaults_to_empty_array(): void
    {
        ...
        $dto = new ResolvedSource($url, $destinationPath, $originalName, $variant);
