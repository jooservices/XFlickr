...
final class PhotoCatalogPresenter
{
     ...
     * @param  array<int, list<array{flickr_id: string, owner_nsid: string, title: string|null}>>  $photosetsByPhotoId
     * @param  array<int, list<array{flickr_id: string, owner_nsid: string, title: string|null}>>  $galleriesByPhotoId
     * @param  Collection<string, StoredFile>  $storedByFlickrPhotoId
     * @return list<array<string, mixed>>
     */
    public function presentPage(
        iterable $photos,
        array $photosetsByPhotoId,
        array $galleriesByPhotoId,
        Collection $storedByFlickrPhotoId,
    ): array {
     ...
     * }>
     */
    public function presentDownloadProgress(array $flickrPhotoIds, Collection $storedByFlickrPhotoId): array
    {
