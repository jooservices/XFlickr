...
use App\Services\Storage\GooglePhotosConnectionVerifier;
use Illuminate\Console\Command;

final class VerifyGooglePhotosConnectionCommand extends Command
{
    protected $signature = 'storage:google-photos:verify {--account= : Storage account ID (defaults to google_photos default)}';
