...
4. [Flickr accounts](02-user-guide/flickr-accounts.md)
...
2. [`ai/README.md`](../ai/README.md) — skills and tool routing
3. [AI development workflow](04-development/ai-development-workflow.md)
4. [AI skills maintenance](04-development/ai-skills.md) — canonical skill format and adapters
5. [Known dangerous commands](05-maintenance/known-dangerous-commands.md)
